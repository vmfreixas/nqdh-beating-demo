...
\begin{figure}[t]
  ...
  \caption{Left panel shows a cartoon of the halofluorescein AB heterodimer having 122 atoms (white corresponds to H, gray to C, blue to N, red to O, and green to Cl atoms). The central panel shows the hippy-nn neural network taking as input the molecule coordinates and delivering the symmetric matrix field $W(R)$. The third panel shows different nonadiabatic dynamics software feeding on a unique $W(R)$.}
  \label{fig:parity}
\end{figure}
